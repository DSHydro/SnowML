...
def create_bucket_dict(b_type):
    ...
    Raises:
        AssertionError: If `b_type` is not one of the permitted types ("prod", "test", "sue-private", "sue-private-test").
    """
    permitted_types = ["prod", "test", "sue-private", "sue-private-test"]
    ...
    elif b_type == "sue-private":
        bucket_names = ["snowml2-shape", "snowml2-bronze", "snowml2-silver", "snowml2-gold", "snowml2-model-ready"]
    else: 
