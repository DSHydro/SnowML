...
def create_bucket_dict(b_type):
    ...
    bucket_types = ["shape-bronze", "swe-bronze",  "swe-silver", "swe-gold", "wrf-bronze", "wrf-silver", "wrf-gold", "model-ready"]
    if b_type == "prod":
        # bucket_names = ["shape-bronze", "dawgs-bronze", "dawgs-silver", \
        #                 "dawgs-gold", "dawgs-model-ready"]
